...
class ClientSync(object):
    ...
    def new_job(self, priority, job_info, inputdata, launcher_name="Unknown", debug=False):
        """
            Runs a new job.
        ...
        self._client.new_job(priority, job_info, inputdata, manage_output, launcher_name, debug)
